 ...
 *
 * 委托给当前生效的 [EvolutionProvider] ([EvolutionProviderRegistry.active]);
 * 默认实现 = [EvolutionEngine] → [EvolutionStore]。钩子永不崩溃。
 *
...
object EvolutionHook {
    ...
    private fun onFailure(entry: ErrorEntry) {
        try {
            ...
            EvolutionProviderRegistry.active().recordFailure(
