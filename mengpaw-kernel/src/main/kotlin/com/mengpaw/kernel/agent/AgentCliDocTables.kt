...
internal object AgentCliDocTables {
    ...
    val AGENT_COMMANDS = listOf(
        ...
        Triple("memory.record", "agent.memory.record <内容>", "写中期记忆 (对话摘要; 梦境自动整理, 不编辑)"),
        Triple("memory.keep", "agent.memory.keep <内容>", "写长期记忆 (用户说记住/你判断重要时)"),
        ...
        Triple("memory.write", "agent.memory.write <id> <内容>", "按 ID 写长期 (存在则更新; 日常用 keep 即可)"),
        Triple("memory.mid", "agent.memory.mid [日期]", "查看中期记忆 (用户提及历史时按日期查)"),
        Triple("memory.project", "agent.memory.project [项目名]", "查看项目记忆 (里程碑/闭环经验)"),
        Triple("memory.project.save", "agent.memory.project.save <项目名> <内容>", "里程碑/阶段完成时提交项目经验 (被动)"),
        Triple("memory.project.delete", "agent.memory.project.delete <项目名>", "删除项目分片 (谨慎, 中危)"),
        Triple("memory.mid.delete", "agent.memory.mid.delete <日期>", "删除中期分片 (梦境自动整理, Agent 一般不使用)"),
        Triple("memory.rm", "agent.memory.rm <时间戳>", "删长期条目 (清理错误, 中危)"),
        Triple("memory.edit", "agent.memory.edit <时间戳> <内容>", "改长期条目 (清理错误, 中危)"),
        Triple("memory.mid.rm", "agent.memory.mid.rm <日期> <时间戳>", "删中期条目 (Agent 一般不使用)"),
        Triple("memory.mid.edit", "agent.memory.mid.edit <日期> <时间戳> <内容>", "改中期条目 (Agent 一般不使用)"),
        Triple("memory.project.rm", "agent.memory.project.rm <项目名> <时间戳>", "删项目条目 (谨慎, 中危)"),
        Triple("memory.project.edit", "agent.memory.project.edit <项目名> <时间戳> <内容>", "改项目条目 (谨慎, 中危)")
    )
