...
When a trigger fires you'll get a message starting with `[Trigger task · CRON]` or `[Trigger task · SCHEDULE]`. Execution rules live in workspace `HEARTBEAT.md`. Keep it lean to save tokens — you're alive: wake up, check inbox, handle todos.
