...
val EnglishStrings = AppStrings(
    ...
    roleRoutingDesc = "Each role can use a different model: strong for planning/verification, cheap for execution; unconfigured roles fall back to the main model.",
...
val ChineseStrings = AppStrings(
    ...
    roleRoutingDesc = "各角色可用不同模型：规划/验收用强模型、执行用便宜模型；未配置的角色回退主模型。",
