...
val EnglishStrings = AppStrings().apply {
    ...
    systemTotalCalls = "Total Calls"
    systemInputTokens = "Input Tokens"
    systemOutputTokens = "Output Tokens"
    systemModelStats = "By Model"
    systemModelName = "Model"
    systemModelTotalTokens = "Total Tokens"
    systemWeekly = "Weekly"
    ...
    agentThinkingEffort = "Thinking Effort"
    agentThinkingEffortDesc = "DeepSeek only: Max/High/Low enable thinking at that effort, Off disables thinking (Low or Off is recommended for agent tasks — it avoids thinking consuming the whole output budget, which shows up as an empty response)"
