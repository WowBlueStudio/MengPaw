...
val ChineseStrings = AppStrings().apply {
    ...
    systemTotalCalls = "总调用次数"
    systemInputTokens = "输入 Token"
    systemOutputTokens = "输出 Token"
    systemModelStats = "按模型统计"
    systemModelName = "模型名称"
    systemModelTotalTokens = "总 Token"
    systemWeekly = "每周"
    ...
    agentThinkingEffort = "思考强度"
    agentThinkingEffortDesc = "仅 DeepSeek：Max/High/Low 开启思考并指定强度，Off 关闭思考（Agent 任务建议 Low 或 Off，可降低思考占满输出预算导致的空响应）"
