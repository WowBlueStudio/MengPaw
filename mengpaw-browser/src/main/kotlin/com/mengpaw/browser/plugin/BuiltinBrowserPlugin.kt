...
""".trimIndent())
    ...
    private suspend fun screenshotElement(args: List<String>, ctx: ExecutionContext): ExecutionResult {
        ...
        return try {
            ...
            val scale = if (vpW.toLong() * vpH > com.mengpaw.browser.bridge.MAX_SCREENSHOT_PIXELS)
                kotlin.math.sqrt(com.mengpaw.browser.bridge.MAX_SCREENSHOT_PIXELS.toDouble() / (vpW.toLong() * vpH)).toFloat()
            else 1f
